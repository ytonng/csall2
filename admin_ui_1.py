...
class Ui_MainWindow(object):
    def save_data_from_frame_to_database(self, new_frame):
        try:
            ...
            new_text_edit_2 = new_frame.findChild(QtWidgets.QTextEdit, "new_text_edit_2")
            ...
            data_params = (
                text_to_save_text_edit2,text_to_save_small_text_edit, text_to_save_text_edit_3, text_to_save_text_edit_4,text_to_save_new_text_edit_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        def add_new_frame():
            ...
            additional_button = QPushButton("Additional Button", new_frame)
            ...
            image_name.setGeometry(QtCore.QRect(450, 250, 150, 500))  # Set the geometry as specified
            image_name.setPlainText("image_name")  # Set the initial text (you can change this)
