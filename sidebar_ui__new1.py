...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def navigate_to_index_3(self):
        # Set the current index of stackedWidget to 3 when the "back_booking" button is clicked
        self.ui.stackedWidget.setCurrentIndex(3)
...
"")
    ...
    def set_placeholder_text(self, user_id):
        ...
        if user_data:
            ...
            contact_number = user_data[7]
            address = user_data[10]
            postcode = user_data[11]
            area = user_data[9]
    ...
    def setup_search_widgets(self):
        ...
        self.Search_attraction.setGeometry(QtCore.QRect(370, 0, 441, 22))
        ...
        self.section.setGeometry(QtCore.QRect(240, 0, 81, 21))
...
"""
    ...
    def show_booking_history(self, user_id):
        ...
        if data:
            for row in data:
                ...
                item.setText(1, str(row[3]))  # Attraction Name
                item.setText(2, str(row[1]))  # Booking Date
                item.setText(3, str(row[5]))  # Quantities
                item.setText(4, str(row[4]))  # Attraction Price
                item.setText(5, str(row[6]))  # Total Amount
                item.setText(6, str(row[2]))  # Status
    ...
    def fetch_and_populate_attractions_booking_data(self):
        try:
            ...
            if attractions_data:
                ...
                for index, (
                    ...
                    # Your existing code for creating frames, labels, and buttons
                    booking_label = QtWidgets.QLabel(new_frame)
                    booking_label.setGeometry(QtCore.QRect(20, 120, 1161, 351))
                    booking_label.setFrameShape(QtWidgets.QFrame.Box)
                    booking_label.setText("")
                    booking_label.setObjectName("booking_label")

                    book_btn = QtWidgets.QPushButton(new_frame)
                    book_btn.setGeometry(QtCore.QRect(1040, 430, 121, 28))
                    ...
                    book_btn.clicked.connect(
                        lambda checked, a_name=attractions_name, a_description=description, a_price=attractions_price,
                               a_image=image_data, d_data=details_data: self.create_booking_page(a_name, a_price,
                                                                                                 d_data))
                    image_label = QtWidgets.QLabel(new_frame)
                    image_label.setGeometry(QtCore.QRect(30, 130, 291, 331))
                    pixmap = QtGui.QPixmap()
                    ...
                    bookingtitle.setGeometry(QtCore.QRect(340, 130, 831, 41))
                    ...
                    booking_price.setGeometry(QtCore.QRect(890, 430, 131, 31))
                    ...
                    booking_address.setGeometry(QtCore.QRect(340, 190, 831, 231))
            ...
            print(f"Error in fetch_and_populate_attractions_data: {e}")
    ...
    def create_booking_page(self, attractions_name, attractions_price, details_data):
        ...
        booking_btn.clicked.connect(
            lambda: self.save_booking_data(self.user_id, attractions_name, check_in_date.date().toString(), comboBox,promocode_entry))
    ...
    def save_booking_data(self, user_id, attractions_name, check_in_date, comboBox, promocode_entry):
        try:
            ...
            if result:
                ...
                # Retrieve the promocode from the QTextEdit
                entered_promocode = promocode_entry.toPlainText()

                # Query to check the validity of the promocode
                promocode_query = "SELECT deals_id, discount FROM deals WHERE promocode = %s ;"
                cursor.execute(promocode_query, (entered_promocode,))
                promocode_result = cursor.fetchone()

                if promocode_result:
                    deals_id, discount_percentage = promocode_result
                    ...
                    # Insert data into the booking_details table with the selected quantity and promocode
                    details_query = "INSERT INTO booking_details (booking_id, attractions_id, quantities, deals_id) " \
                                    "VALUES (%s, %s, %s, %s);"
                    details_data = (booking_id, attractions_id, selected_quantity, deals_id)
                    ...
                    total_amount = self.calculate_total_amount(attractions_price, selected_quantity,
                    ...
                    QMessageBox.information(
                        ...
                        f"Total Amount with Discount: RM {total_amount:.2f}"
                    )
    ...
    def send_email(self, hotel_name, check_in_date):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.headerItem().setText(5, _translate("MainWindow", "Total Amount After Discouont"))
    ...
    def open_chatbot_page_1(self):
        ...
        web_view.setUrl(QtCore.QUrl.fromLocalFile("C:/Users/60111/Downloads/chatbot.html"))
